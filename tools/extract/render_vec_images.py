...
TARGETS = ([("MONDE%d.VEC" % n, "results/levels_png", "world%d.png" % n) for n in range(1, 10)]
           + [("TITRE.VEC", "results/images", "titre.png"),
              ("DESSFIN.VEC", "results/images", "dessfin.png"),
              ("SCORE.VEC", "results/images", "score.png"),
              ("BUMPRESE.VEC", "results/images", "bumprese.png"),   # "BUMpy PRESEntation" splash
              ("MASKBUMP.VEC", "results/images", "maskbump.png")])  # EASY/MEDIUM/HARD difficulty UI
