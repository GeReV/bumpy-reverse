...
/* Faithful C ports of the entity draw functions from spawn_and_draw_level_entities
   ...
   * Erase / render_player_view RECONSTRUCTED (see src/bgi_overlay.c,
     ...
     (An earlier note here called these steps "omitted" or render_player_view a visible
     "second pass / out of scope"; both were misdiagnoses, corrected after dynamic
